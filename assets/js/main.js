...
//     var $owlWork = $('.js-carousel-work');
//     var $owlFirms = $('.js-carousel-firms');
//
//     $owlWork.owlCarousel({
//         items: 4,
//         margin: 20,
...
$(document).ready(function(){
	var $contentNavigate = $('[data-nav-page]'),
		navItems = [];

	if ( $contentNavigate.length ){

		$contentNavigate.each(function(){
			var $this = $(this),
				title = $this.data('nav-page'),
				hash =  '#' + $this[0].id;

			navItems.push('<li data-title="'+title+'" class="nav__item js-nav__item"><a href="'+hash+'"></a></li>')
		});
